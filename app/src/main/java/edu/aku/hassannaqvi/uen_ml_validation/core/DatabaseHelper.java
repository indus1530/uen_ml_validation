package edu.aku.hassannaqvi.uen_ml_validation.core;
...
import edu.aku.hassannaqvi.uen_ml_validation.contracts.AreasContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.AreasContract.singleAreas;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.BLRandomContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.BLRandomContract.SingleRandomHH;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.ChildContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.ChildContract.SingleChild;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.EnumBlockContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.EnumBlockContract.EnumBlockTable;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.FamilyMembersContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.FamilyMembersContract.SingleMember;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.FormsContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.KishMWRAContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.KishMWRAContract.SingleKishMWRA;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.MWRAContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.MWRAContract.MWRATable;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.MWRA_PREContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.MWRA_PREContract.SingleMWRAPRE;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.MortalityContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.MortalityContract.SingleMortality;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.TalukasContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.UCsContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.UsersContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.VersionAppContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.VillagesContract;
import edu.aku.hassannaqvi.uen_ml_validation.contracts.VillagesContract.SingleVillage;

import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.DATABASE_NAME;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.DATABASE_VERSION;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_BL_RANDOM;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_CHILD_TABLE;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_FAMILY_MEMBERS;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_FORMS;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_KISH_TABLE;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_MORTALITY;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_MWRAPRE_TABLE;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_MWRA_TABLE;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_PSU_TABLE;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_USERS;
import static edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable.SQL_CREATE_VERSIONAPP;
