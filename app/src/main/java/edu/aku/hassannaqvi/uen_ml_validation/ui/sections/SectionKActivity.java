    ...
    public void BtnContinue() {
        if (formValidation()) {
            ...
            if (UpdateDB()) {
                ...
                Class nextClass = lstU5 != null ? lstU5.size() > 0 ? SectionI1Activity.class : EndingActivity.class : EndingActivity.class;
                startActivity(new Intent(this, nextClass).putExtra("complete", true));
            } else {
