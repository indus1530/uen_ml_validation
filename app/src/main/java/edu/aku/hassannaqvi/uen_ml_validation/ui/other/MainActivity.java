...
import edu.aku.hassannaqvi.uen_ml_validation.core.AndroidDatabaseManager;
...
import edu.aku.hassannaqvi.uen_ml_validation.databinding.ActivityMainBinding;
import edu.aku.hassannaqvi.uen_ml_validation.ui.sections.SectionAActivity;
import edu.aku.hassannaqvi.uen_ml_validation.ui.sync.SyncActivity;
import edu.aku.hassannaqvi.uen_ml_validation.utils.CreateTable;
    ...
    public static class MyDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setTitle("UeN Midline Validation APP is available!")
                    .setCancelable(false)
                    .setMessage("UeN Midline Validation App " + newVer + " is now available. Your are currently using older version " + preVer + ".\nInstall new version to use this app.")
